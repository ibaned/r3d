...
static void test_3d() {
  ...
  assert(r3d::are_close(
      faces[0].n, -r3d::normalize(r3d::vector_3(1, 1, 1))));
  ...
  assert(
      r3d::are_close(volume, (1. / 6.) - (r3d::cube(0.5) / 6.)));
...
static void test_2d() {
  ...
  assert(r3d::are_close(
      faces[1].n, -r3d::normalize(r3d::vector_2(1, 1))));
  ...
  area = r3d::measure(c);
  assert(
      r3d::are_close(area, (1. / 2.) - (r3d::square(0.5) / 2.0)));
